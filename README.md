...
Durante estas aulas, foquei na base fundamental do desenvolvimento web, incluindo:
- **Estrutura Semântica**: Utilização correta de tags como `main`, `header`, `footer` e `article`.
- **Mídias na Web**: Inserção de imagens (PNG, JPG, SVG) e incorporação de vídeos do YouTube via `iframe`.
